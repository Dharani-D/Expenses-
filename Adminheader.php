					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							...
							<li class="nav-item active"><a class="nav-link" href="adminhome.php">Home</a></li> 
								...
								<li class="nav-item"><a class="nav-link" href="Addexpense.php">Expense Master</a></li> 
								<li class="nav-item"><a class="nav-link" href="Addexpensedet.php">Expense Entry</a></li> 
